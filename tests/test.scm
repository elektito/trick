...
(eqv? 100 (if #t 100 200))
(eqv? 200 (if #f 100 200))
(eqv? 100 (if 0 100 200))
(eqv? 100 (if 1 100 200))
(eqv? 100 (if "foo" 100 200))
(eqv? 100 (if (lambda (x) x) 100 200))
(eqv? 100 (if #() 100 200))
(eqv? 100 (if #(1) 100 200))
(eqv? 100 (if #t 100))
(eq? (#$void) (if #f 100))
...
(= 2 (floor-quotient 8 3))
(= -3 (floor-quotient -8 3))
(= 2 (truncate-quotient 8 3))
(= -2 (truncate-quotient -8 3))
...
(eqv? 10 ((lambda (x y) x) 10 20))
(eqv? 20 ((lambda (x y) y) 10 20))
...
(eqv? #\a (char-downcase #\A))
(eqv? #\1 (char-downcase #\1))
(eqv? #\ف (char-downcase #\ف))

(eqv? #\a (char-foldcase #\a))
(eqv? #\a (char-foldcase #\A))
(eqv? #\1 (char-foldcase #\1))
(eqv? #\ف (char-foldcase #\ف))
...
(eqv? 10 (string-length (make-string 10 #\A)))
(eqv? 10 (string-length (make-string 10)))

(string=? "" (string))
(string=? "A" (string #\A))
(string=? "ABC" (string #\A #\B #\C))

(eqv? #\A (string-ref "ABC" 0))
(eqv? #\B (string-ref "ABC" 1))
(eqv? #\C (string-ref "ABC" 2))
